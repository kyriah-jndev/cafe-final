...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def categoricaloptions(Name, baseprice, cat):
            ...
            #calculates price
            #def priice():
              # global priices, baseprices, cat, pricetotal111
            
            #sets the default choice to a the select color and sets the color to the new color when pressed
            def choices(ID, option, price123, name):
              global priices, optionselected, pricetotalamount, price1234
              price1234 = price123
              ...
              pricetotalamount = price123 + baseprices
        ...
        def Hotdrinks(Name, baseprice, cat):
            ...
            addingbut = Button(optionFrame, text ="Add", width = 8, height = 1, font=('Helvetica', 20, 'bold'), bg = color2, fg = "white", anchor = NW, command=lambda: addfunc(Name, 0, pricetotal))
            addingbut.place (x = 415, y = 912)
            options = Label(optionFrame, text = "Options:" + Name ,bd = 0, width = 35, height = 1, anchor = NW, bg = color1, fg = "white", font=('Helvetica', 20, 'bold'))
            options.place (x = 0, y = 0)
